...
<!--
	作者：suliangbo2010@163.com
	时间：2015-04-14
	描述：微博接入
-->
<meta property="wb:webmaster" content="385ea8a3160d001c" />
			...
			<div class="header-box">
				<div class="left">
					<div class="right">
						<nav>
							<ul>
								<li class="current"><a href="jsp/index.jsp">Home</a></li>
								<li><a href="jsp/services.jsp">Services</a></li>
								<li><a href="jsp/hosting.jsp">Hosting</a></li>
								<li><a href="jsp/solutions.jsp">Solutions</a></li>
								<li><a href="jsp/support.jsp">Support</a></li>
								<li><a href="jsp/contacts.jsp">Contacts</a></li>
							</ul>
						</nav>
						<h1><a href="jsp/index.jsp"><span>Smart</span>Net</a></h1>
					</div>
				</div>
			</div>
			<span class="top-info">漫谈生活，在自己的生活频道畅谈属于您的生活！</span>
