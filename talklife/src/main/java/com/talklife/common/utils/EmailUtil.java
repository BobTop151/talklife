...
public class EmailUtil
{
	...
	public static void main(String[] args)
	{
		 ...
		 *************切切注意********
		 */
		EmailUtil themail = new EmailUtil("smtp.talklife.com.cn");//这里以新浪邮箱为例子
		...
		themail.setTo("1140278501@qq.com");//收件人地址
		themail.setFrom("service@talklife.com.cn");//发件人地址
		themail.addFileAffix("I:/ibatis-2.3.4.726.zip");// 附件文件路径,例如：C:/222.jpg,*注；"/"的写法； 如果没有可以不写
		themail.setNamePass("service@talklife.com.cn", "bob_top151");//发件人地址和密码 **改为相应邮箱密码
		themail.sendout();
	}
}
